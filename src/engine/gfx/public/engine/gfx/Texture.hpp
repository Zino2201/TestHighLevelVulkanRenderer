...
CB_ENABLE_FLAG_ENUMS(TextureAspectFlagBits, TextureAspectFlags);
...
CB_ENABLE_FLAG_ENUMS(TextureUsageFlagBits, TextureUsageFlags);
...
CB_ENABLE_FLAG_ENUMS(SampleCountFlagBits, SampleCountFlags);
...
struct TextureViewCreateInfo
{
	...
	TextureViewCreateInfo(const DeviceResource& in_texture,
